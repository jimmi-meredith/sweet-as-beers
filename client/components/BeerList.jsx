...
const BeerList = props => {
  return (
    <div className='beerlist'>
      ...
      <div className="beer">
        <p className="name">Mangose & Melons</p>
        <p className="description">A Fruit Gose from Baylands Brewery</p>
        <p>
          <span className="country">New Zealand</span>
          <span className="abv">4% abv</span>
          <a href="/designs/cart.html" className="cart-link">Add to cart</a>
        </p>
      </div>

      <div className="beer">
        <p className="name">North End Pilsner</p>
        <p className="description">A Pilsner from North End Brewing</p>
        <p>
          <span className="country">New Zealand</span>
          <span className="abv">5% abv</span>
          <a href="/designs/cart.html" className="cart-link">Add to cart</a>
